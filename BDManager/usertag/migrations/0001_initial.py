    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cd', models.ForeignKey(db_column='CD_ID', on_delete=django.db.models.deletion.DO_NOTHING, to='usertag.Cds')),
            ],
            options={
                'db_table': 'COLUMNS_V2',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cd', models.ForeignKey(blank=True, db_column='CD_ID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='usertag.Cds')),
            ],
            options={
                'db_table': 'SDS',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('db', models.ForeignKey(blank=True, db_column='DB_ID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='usertag.Dbs')),
                ('sd', models.ForeignKey(blank=True, db_column='SD_ID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='usertag.Sds')),
            ],
            options={
                'db_table': 'TBLS',
            },
        ...
        migrations.AlterUniqueTogether(
            name='usergroupcolumnlabelrelation',
            unique_together=set([('group_id', 'label_id')]),
        ),
        migrations.AddField(
            model_name='sds',
            name='serde',
            field=models.ForeignKey(blank=True, db_column='SERDE_ID', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='usertag.Serdes'),
        ),
        migrations.AlterUniqueTogether(
            name='tbls',
            unique_together=set([('tbl_name', 'db')]),
        ),
        migrations.AlterUniqueTogether(
            name='columnsv2',
            unique_together=set([('cd', 'column_name')]),
        ),
    ]
